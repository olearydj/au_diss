...
def generate_markdown_report(xml_file_path):
    ...
    metadata = {
        ...
        'last_modified': root.find("descriptive-metadata/context-info/last-modified").text,
        'title': root.find("descriptive-metadata/title").text,
        'description': root.find("descriptive-metadata/description").text,
        'in_point': (int(root.find("descriptive-metadata/in-point").text), root.find("descriptive-metadata/in-point").get("time-base")),
        'out_point': (int(root.find("descriptive-metadata/out-point").text), root.find("descriptive-metadata/out-point").get("time-base")),
    ...
    for marker_elem in root.findall("descriptive-metadata/marker"):
        marker = {
            ...
            'timestamp': (int(marker_elem.find("timestamp").text), marker_elem.find("timestamp").get("time-base")),
        ...
        if marker_elem.find("duration") is not None:
            marker['duration'] = (int(marker_elem.find("duration").text), marker_elem.find("duration").get("time-base"))
