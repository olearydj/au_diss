...
This chapter explores the most relevant literature reviewed and provides a synthesis of the findings as they relate to this study. Due to the nature of this study, the scope of this review was quite broad, spanning the theoretical bases of support for augmented learning, the affordances and theoretical benefits of XR-based learning, and the readiness of the market including barriers to adoption. Furthermore, it investigates methods to address key barriers, including frameworks for specification, design, implementation, and assessment. Finally, it addresses the state of assessment methods in or relevant to manufacturing.
...
## Claims / Argument / Logic? Name???

This section will lay out the argument that

Recent advancements in XR, particularly AR and MR, have emerged as promising tools to meet these demands by offering real-time, contextually relevant instruction. Initial research and development efforts into AR for manufacturing assembly training have shown its potential, but widespread industry adoption is contingent upon measurable real-world benefits and a clear return on investment. Additional barriers to AR adoption include technical challenges, lack of standardization, and interoperability issues.

Despite ongoing efforts to develop standards and evaluation frameworks to mitigate these barriers, the evidence base for the efficacy of AR in enhancing manufacturing training remains fragmented.

This fragmentation, often focusing on the technology rather than its affordances, limits the comparability of research findings. Addressing this gap requires a novel approach to research that prioritizes the evaluation of AR's unique affordances over device-centric metrics. This approach aims to provide a clearer understanding of how AR can be effectively implemented in manufacturing training protocols, ultimately supporting the industry's need for efficient and effective operator training solutions.

### Manufacturing Has a Need
...
### AR is a Potential Solution

3. Advances in XR technologies, particularly Augmented Reality (AR), offer novel opportunities for interactive and immersive training in manufacturing.
4. Preliminary research and development (R&D) efforts indicate that AR can enhance manufacturing assembly training by providing real-time, contextually relevant information.

### Barriers to Widespread Industry Adoption

5. Despite promising results from pilot studies, widespread industry adoption of AR for training requires clear justification in terms of return on investment (ROI) and demonstrable improvements in training outcomes.
6. Several barriers hinder the adoption of AR for manufacturing training, including technical limitations, lack of interoperability, and the absence of standardized evaluation frameworks.

### Frameworks

7. Existing efforts to develop standards, frameworks, and assessment methods aim to address operational barriers

### Case Studies

8. Case studies aim to address need for empirical evidence of benefits
9. Current studies on the efficacy of AR in manufacturing training are fragmented, often device-centric, and lack a consistent approach to evaluating AR’s unique affordances.

## Conclusions

9. There is a critical need for research methodologies that holistically evaluate the impact of AR's affordances on learning outcomes in manufacturing training.
10. Closing the gap in evidence regarding the effectiveness of AR for manufacturing training requires focusing on affordances and conducting comparative analyses across different AR implementations.
...
DJO: XR as effective with an advantage in physical / spatial tasks (validates educational theoretical underpinnings); secondary benefits may be source of value differentiation; need more research on effects of user differences and tech quality and fidelity; diverse study designs and lack of research, lack of standard efficacy metrics require more unified methodological approach
...
DJO: sys review; summarizes general pros and cons - better suited to the benefits section?

@parsons2021curre advocate for an affordance-based approach when analyzing AR applications for learning, emphasizing the benefits of this approach over a feature-based perspective. They claim affordances are more generalizable than specific implementations and enable comparison across contexts, while still being highly contextualized to the domain of interest. Their systematic review of 21 empirical studies found that "studies that did not address any of the key affordances identified as relevant ... showed relatively poor learning outcomes" [-@parsons2021curre, pp. 89-90]. This suggests paying close attention to relevant affordances when designing AR systems may lead to better results. 

Through their review, the authors synthesized five key affordances of AR that can enhance learning in medical education: (1) reducing negative impacts like risk and cost, (2) visualizing the invisible, (3) developing practical skills in a spatial context, (4) enabling device portability across locations, and (5) facilitating situated learning grounded in the professional context. 

By highlighting the rationale for an affordance-based approach and the specific affordances identified as relevant for training in this hands-on domain, the authors provide a strong framework for adopting a similar approach.
...
The substantial unexplained heterogeneity (I^2=72%) across studies in Moro et al.'s [-@moro2021virtu] meta-analysis of VR/AR for anatomy and physiology education was likely due to the heterogeneity of study designs, such as variation in XR hardware, augmentation methods, task types and domains - issues also noted by *Kaplan et al.* and others.
