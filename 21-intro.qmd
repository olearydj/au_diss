...
![Enabling technology categories of Industry 4.0. @culot2020behin](images/21-EnablingTechCategories.png){#fig-tech fig-align="center" width="4.5in"}
...
![5C architecture to implement I4.0 CPS. @lee2015cyber, as adapted by @pascual2019handb](images/21-5CArchitecture.png){#fig-5c fig-align="center" width="4.5in"}
...
![The Digital Twinning Process. @jones2020chara](images/21-DigitalTwinningProcess.png){#fig-twinning fig-align="center" width="4.5in"}
...
![The Virtuality Continuum. @milgram1994taxon](/images/21-VirtualityContinuum.png){#fig-vc fig-align="center" width="4.5in"}
...
![Heilig's Stereoscopic Television Apparatus. @heilig1960stere](images/21-HeiligStereoscopicTV.png){#fig-heilig fig-align="center" width="4.5in"}
...
![FOV2GO, IEEE VR Conference 2012 Poster. @olson2011desig](images/21-FOV2GoPoster.png){#fig-fov2go fig-align="center" width="4.5in"}
...
Traditional AR and VR devices integrate computation, sensors, and displays into a HMD, which may suggest they offer a similar experience and benefits. Both offer novel forms of visualization and interaction, but the essential characteristics ("affordances"[^21-intro-8]) of each are entirely different. VR is a new medium that immerses the senses in a virtual replacement for reality and, through the psychological phenomena of presence, mimics the effects of as-lived events [@bailenson2018exper]. AR is a new model of computing that augments our perception of reality and, through a natural, spatially connected interface, enhances our understanding of and interactions with the real world [@azuma2019road]. Where VR is an extension of games and film, AR is seen as the most likely next step on the path towards ubiquitous computing.

[^21-intro-8]: In the study of interaction design and related fields these characteristics are referred to as *affordances:* the quality or property of an object that defines its possible uses or makes clear how it can or should be used [@norman2013desig].
...
[^21-intro-9]: Dr. Kress was principal optical architect on the Google Glass project before joining Microsoft in a similar role for their first and second generation HoloLens devices. He has since returned to Google as their Director for XR Engineering. He serves as Vice President of the International Society for Optics and Photonics (SPIE). Dr. Kress' publications are heavily leveraged throughout this section. [spie.org/profile/Bernard.Kress-16356](https://spie.org/profile/Bernard.Kress-16356)

![Current product offerings by device class and market. @kress2020optic](images/21-ARVRProductOfferings.png){#fig-offerings fig-align="center" width="4.5in"}
...
![Functional building blocks of an OST XR HMD. @kress2020artif](images/21-BlocksOST-XR-HMD.png){#fig-buildblocks fig-align="center" width="4.5in"}
...
![Comfort and immersion requirements for an ideal MR experience. From @kress2020optic](images/21-ComfortAndImmersionMR.png){#fig-requirements fig-align="center" width="4.5in"}
...
![Sensor fusion flow in typical MR systems. @kress2020optic](images/21-SensorFusionFlowMR.png){#fig-fusion fig-align="center" width="4.5in"}
...
![(a) Rod and cone cell density on the retina, and (b) optical axis and line of sight. @kress2020optic](images/21-RodAndConeDensity.png){#fig-acuity fig-align="center" width="4.5in"}
...
![Binocular field of view. @kress2020optic](images/21-BinocularFOV.png){#fig-binocfov fig-align="center" width="4.5in"}
...
![Typical FOVs for SOTA XR HMDs. @kress2020optic](images/21-XR-HMD-FOVs.png){#fig-xrfov fig-align="center" width="4.5in"}
...
![AR Tracking: spatial coherence is achieved by aligning real and virtual cameras with shared intrinsic properties. @marchand2016pose](images/21-ARTracking.png){#fig-tracking fig-align="center" width="4.5in"}
...
![The pose estimation problem. @opencv2022pnp](images/21-PoseEstimation.png){#fig-estpose fig-align="center" width="4.5in"}
...
![Marker-based tracking pipeline. @yang2015scala](images/21-MarkerBasedTrackingPipeline.png){#fig-markers fig-align="center" width="4.5in"}
...
![Requirements from various HMD market segments. Number of '+/-' markers indicates magnitude of positive/negative criticality. @kress2015optic](images/21-HMDRequirements.png){fig-align="center" width="4.5in"}
...
Focused activity can lead to a state of psychological absorption. This intuitive phenomena is known as flow, a term coined by Mihály Csikszentmihályi[^21-intro-14] who described it as the "optimal experience" [@csikszentmihalyi1990flow]. Flow is a cognitive and affective state in which individual attention and motivation feel in harmony with the situation. This leads to a period of absorbed productivity wherein the normal concern for our immediate needs abates. Most of us recognize this highly gratifying experience, which is colloquially known as being in the zone or groove. Many previous studies have established flow's positive influence on learning effects [@kwon2018verif].

[^21-intro-14]: This Hungarian name is pronounced *me-high chick-sent-me-high*
