...
Manual data collection was limited during the learning and recall experiments. Each assembly was reviewed for correctness and the number and types of uncorrected errors were recorded on the appropriate data sheet. It is important to note that only the correct type, location, and orientation of each brick is confirmed, and not how securely it is attached. For incomplete (time expired) or retired (breakage requiring rework) assemblies, the final part count was also recorded.
