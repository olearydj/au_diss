...
[^24-methods-16]: MRTK Unity Documentation: <https://learn.microsoft.com/en-us/windows/mixed-reality/mrtk-unity/mrtk2/?view=mrtkunity-2022-05>
...
For HMDAR tracking, we relied on VE's *Area Targets*[^24-methods-18] feature, an implementation of the area-based tracking methods described in @sec-tracking. This approach was chosen over image-based methods, which can be more sensitive to drop-out and require permanent markers.

[^24-methods-18]: Vuforia Area Targets: <https://developer.vuforia.com/library/environments/area-targets>

The area-based tracking method compares a 3D model of the workspace with a real-time spatial map of the same to determine the current position and angle of the participant's head relative to it. The spatial map is a polygonal mesh generated by the HL2 at runtime. It is created with live scene data from the depth sensor, visible light cameras, and inertial measurement unit. A sample is shown in @fig-spatmap.
...
TODO: elaborate on list of challenges and/or convert into narrative
...
As with any protocol that involves human participants, this study required Institutional Review Board (IRB) approval. An initial review of the protocol found that it created minimal risk to participants, did not involve vulnerable populations, invasive methods, or sensitive data, and required informed consent. Furthermore, it involved the "collection of data from voice, video, digital, or image recordings," which is identified by the University as a category of research eligible for expedited review.[^24-methods-27]

[^24-methods-27]: Per AU IRB Expedited Category Guidance: <https://cws.auburn.edu/shared/files?id=159&filename=AU%20Expedited%20Categories%20Guidance.doc>
