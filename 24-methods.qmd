...
Wherever appropriate, working files, including all data analysis in R and Python, and manuscript development in Quarto[^24-methods-41], were placed under version control using Git[^24-methods-42], and synchronized to GitHub. HL2 source code was treated separately, as discussed in @sec-devtactics.

[^24-methods-41]: Quarto: <https://quarto.org/>

[^24-methods-42]: Git: <https://git-scm.com/>
...
This section will first detail the procedures for data preparation, then summarize the intended analytical approach before discussing data security and other considerations. Analysis will be implemented and more thoroughly detailed in the [Results](#25-results) chapter to follow.

Discuss strategy for pulling data from XLSX, etc. and generating CSV files for subsequent analysis. Separate ingestion and cleaning sections?

### Strategy

The primary outputs of the prior extraction effort were:

1.  Composite videos in `mp4` format, for each participant performing the learning and recall experiments.
...
4.  An Excel file in `xlsx` format, comprised of all transcribed self-reported data and manually recorded results.
...
::: content-hidden
-   **Ethical Handling of Data**: Include a note on how data privacy and ethical considerations are handled, especially if the data includes participant information.
-   **Inter-rater Reliability**: If applicable, discuss how inter-rater reliability was ensured in the data extraction and annotation process.
:::
