...
![LeoCAD Interface Screenshot](images/24-LeoCAD.png){#fig-leocad-a}

![Model Target Constructed in LeoCAD](images/24-ModelTarget.png){#fig-leocad-b}
...
This section will describe the operational details for conducting the protocol in the first session, including the learning and recall phases.

### Session Preparation

Trial Preparation
Steps taken to prepare for each trial (e.g., equipment setup, calibration)
Pre-trial checks or procedures to ensure readiness
...
Process of welcoming and orienting participants
Explanation of informed consent procedures
Description of any pre-experiment questionnaires or assessments

Prior to the first session, each consented participant is required to complete a the Participant Intake Sheet, a trial run of the NASA TLX, and the Behavioral Control Survey.

In preparation for the study, participants were familiarized with the instrument through instruction and a trial run, as described in @sec-conduct1. This is in accordance with the experimental procedure outlined in the TLX instructions.
...
Trial Process
Step-by-step breakdown of how each trial was conducted
Description of the tasks participants performed
Explanation of how instructions were provided and how participant queries were handled

Data Collection and Management
Description of how data was collected during the trials
Information on data recording equipment and techniques
Explanation of how data was stored, managed, and protected
...
Debriefing and Participant Feedback
Explanation of the debriefing process post-trial
How participant feedback was collected and utilized

### Post-Session Procedures

Post-Trial Procedures
Description of post-trial activities (e.g., equipment teardown, data backup)
Follow-up procedures with participants if applicable
...
Personnel and Certifications
Description of the team involved in conducting the trials
Specific roles and responsibilities of each team member
Relevant certifications or training completed by personnel (e.g., ethics training, safety certifications)
...
Trial Schedule
Details on the overall timeline of the study
Specific days and times when trials were conducted
Any variations or adjustments made to the schedule and reasons for these changes
...
Description of safety protocols and measures in place
Explanation of how unexpected events or emergencies were handled
Details on any contingency plans used during the study

### Quality Assurance and Protocol Adherence

Quality Assurance and Protocol Adherence
Measures taken to ensure consistency and quality across trials
Strategies used to monitor and maintain adherence to the protocol

### Challenges and Modifications

better suited to results?

Discussion of any challenges encountered during the conduct of the protocol
Modifications made to the protocol in response to these challenges
