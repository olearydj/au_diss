...
This design links the chosen affordances with the framework for instructional design with AR/MR augmentation for industrial training applications that was proposed in @sec-framework and illustrated by @fig-idforar.
...
Beyond the privacy and data concerns previously described, other potential risks and discomforts were identified. Prolonged used of HMD VSTs has been reported to cause mild neck strain, disorientation, and eye strain in some cases. (TODO: CITE?) The optical and physical design of these systems can also result in a limited or obscured field of view and degraded acuity, (TODO: CITE?) which could increase the participant's risk of trip or impact.
