...
The results were collected in a separate Markdown[^24-methods-37] file (`md`) for each participant. Markdown is a lightweight plain-text formatting syntax proposed by John Gruber in 2004[^24-methods-38]. Originally intended as a tool for HTML generation, Markdown is now widely used to create text documents that have structure and are easily rendered in a variety of styles.

[^24-methods-37]: Markdown: <https://en.wikipedia.org/wiki/Markdown>

[^24-methods-38]: Original Markdown Project Home: <https://daringfireball.net/projects/markdown/>
...
1.  Filmora[^24-methods-34] v12.x was selected to combine the raw video into a split screen presentation with synced action. This facilitated annotation by providing two angles of the action and a zoomed view. Filmora is an affordable, non-destructive editor that offers a good balance of capabilities and ease of use.

2.  Handbrake[^24-methods-35] v1.7.x was selected to downsize and compress Filmora output, improving performance during annotation. Handbrake did this much faster and with better final quality than Filmora. This popular and highly-regarded tool is free and open-source.

3.  Kyno[^24-methods-36] v1.8.x was selected to add markers for instantaneous events (e.g. breakage occurs) and sub-clips for events with duration (e.g. task completion times). Notes can be added to either as desired. The metadata is exported in eXtensible Markup Language [XML, @w3c2008xml], a flexible, text-based language that is used to structure, store, and transport data. Kyno is specifically designed to accelerate this task in a production environment and is generously priced for the market.

[^24-methods-34]: Filmora: <https://filmora.wondershare.com/>

[^24-methods-35]: Handbrake: <https://handbrake.fr/>

[^24-methods-36]: Kyno: <https://lesspain.software/kyno/>
...
>Data Storage and Backup: How and where the data was stored, including details of physical and digital security measures, backup frequencies, and storage formats.
>
>Version Control: How you managed different versions of your data, including any software or systems used for version tracking and control.
>
>Ethical Considerations: How your data handling practices align with ethical standards, particularly concerning participant confidentiality, data integrity, and reproducibility.
>
>Implications for Reproducibility: Explain how these practices support the reliability and reproducibility of your research.

Discuss version control, data security, and traceability, especially as each relate to ethics and reproducability

portability - The same file can be used by other researchers interested in further annotating the video.

### Challenges

Discuss related challenges

sync is hard, dropped frames on HL2 made sync drift; use side camera for marker placement
...
-   plus 10 mins processing time per output video = 2 x 62 x 10 mins = 20.7 hours

-   can be overlapped some

-   total time per participant ≈ 45mins min, 2.5hrs max, 1.25hrs avg
...
TODO: mention emphasis on reproducability, traceability, etc.
